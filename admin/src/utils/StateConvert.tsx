...
type stateType = { state: "unavailable" | "available" | "using" | "booked" |  'cancel' | 'init' | 'confirmed' | 'contract confirmed' | 'deposited' | 'paid' | 'processing' | 'finished' }
...
const StateConvert = (props: stateType)=>{
    ...
    switch (state) {
        ...
        case "cancel" :
            return <p className="font-semibold text-orange-700">Đã hủy</p>
        default:
            return <p></p>
    }
}
